...
def create_world(count_x, count_y, data):        
    print("\n========================================")
    print("  output Ver. 2.14 (20200730)")
    print("========================================\n")
    ...
    for i in range(count_y + 2):
        outfile.writelines(str(count_y+1-i))
        conma2 = ','
        outfile.write(conma2)
    conma3 = '-1,\n'
    outfile.write(conma3)
    ...
    outfile.write(textc)
    for i in range(count_x + 2):
        outfile.writelines(str(count_x+1-i))
        conma2 = ','
        outfile.write(conma2)
    conma3 = '-1,\n'
    outfile.write(conma3)
